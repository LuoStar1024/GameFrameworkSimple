...
namespace GameFramework.Event
{
    ...
    public interface IEventManager
    {
        ...
        bool Subscribe(int eventType, GameFrameworkAction handler);
        ...
        /// <returns>是否订阅成功。</returns>
        bool Subscribe<TArg1>(int eventType, GameFrameworkAction<TArg1> handler);
        ...
        /// <returns>是否订阅成功。</returns>
        bool Subscribe<TArg1, TArg2>(int eventType, GameFrameworkAction<TArg1, TArg2> handler);
        ...
        /// <returns>是否订阅成功。</returns>
        bool Subscribe<TArg1, TArg2, TArg3>(int eventType, GameFrameworkAction<TArg1, TArg2, TArg3> handler);
        ...
        /// <returns>是否订阅成功。</returns>
        void Unsubscribe(int eventType, GameFrameworkAction handler);
        ...
        /// <typeparam name="TArg1">事件参数1类型。</typeparam>
        /// <returns>是否订阅成功。</returns>
        void Unsubscribe<TArg1>(int eventType, GameFrameworkAction<TArg1> handler);
        ...
        /// <typeparam name="TArg2">事件参数1类型。</typeparam>
        /// <returns>是否订阅成功。</returns>
        void Unsubscribe<TArg1, TArg2>(int eventType, GameFrameworkAction<TArg1, TArg2> handler);
        ...
        /// <typeparam name="TArg3">事件参数3类型。</typeparam>
        /// <returns>是否订阅成功。</returns>
        void Unsubscribe<TArg1, TArg2, TArg3>(int eventType, GameFrameworkAction<TArg1, TArg2, TArg3> handler);
