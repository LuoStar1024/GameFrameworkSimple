namespace GameFramework.Timer
{
    ...
    public interface ITimerManager
    {
        ...
        int AddTimer(float time, GameFrameworkActionArgs callback, int repeatCount = 1, bool isUnscaled = false, params object[] args);
        ...
        /// <param name="repeatCount">调用次数，小于等于0为无限。</param>
        /// <param name="isUnscaled">是否不受时间缩放影响。</param>
        void Reset(int timerId, float time, GameFrameworkActionArgs callback, int repeatCount = 1, bool isUnscaled = false);
