...
namespace UnityGameFramework.Editor
{
    ...
    {
        private static readonly string[] s_ResourceModeNames = new string[]
        {
        ...
        private static readonly string[] s_VerifyLevelNames = new string[]
        {
            "Low (验证文件存在)",
            "Middle (验证文件大小)",
            "High (验证文件大小和CRC)"
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                else
                {
                    ...
                    int selectedVerifyIndex = EditorGUILayout.Popup("VerifyLevel", m_VerifyIndex, s_VerifyLevelNames);
