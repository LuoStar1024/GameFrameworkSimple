...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class DebuggerComponent : GameFrameworkComponent
    {
        ...
        // private NetworkInformationWindow m_NetworkInformationWindow = new NetworkInformationWindow(); // 删除 网络
        ...
        private void Start()
        {
            ...
            // RegisterDebuggerWindow("Profiler/Network", m_NetworkInformationWindow); // 删除网络
