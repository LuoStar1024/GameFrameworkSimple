...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class ResourceComponent : GameFrameworkComponent
    {
        ...
        [SerializeField]
        private string m_ResourceLoadHelperTypeName = "UnityGameFramework.Runtime.YooResourceLoadHelper";
        ...
        /// 获取当前资源适用的游戏版本号。
        /// </summary>
        public string ApplicableGameVersion => m_ResourceLoadHelper.ApplicableGameVersion;

        /// <summary>
    /// 获取当前内部资源版本号。
        /// </summary>
        public int InternalResourceVersion => m_ResourceLoadHelper.InternalResourceVersion;
        ...
        /// 获取资源只读路径。
        /// </summary>
        public string ReadOnlyPath => m_ResourceLoadHelper?.ReadOnlyPath;

        /// <summary>
        /// 获取资源读写路径。
        /// </summary>
        public string ReadWritePath => m_ResourceLoadHelper?.ReadWritePath;
        ...
        public float AssetAutoReleaseInterval
        {
            get
            {
                return m_ResourceLoadHelper.AssetAutoReleaseInterval;
            }
            set
            {
                m_ResourceLoadHelper.AssetAutoReleaseInterval = m_AssetAutoReleaseInterval = value;
            }
        }
        ...
        public int AssetCapacity
        {
            get
            {
                return m_ResourceLoadHelper.AssetCapacity;
            }
            set
            {
                m_ResourceLoadHelper.AssetCapacity = m_AssetCapacity = value;
            }
        }
        ...
        public float AssetExpireTime
        {
            get
            {
                return m_ResourceLoadHelper.AssetExpireTime;
            }
            set
            {
                m_ResourceLoadHelper.AssetExpireTime = m_AssetExpireTime = value;
            }
        }
        ...
        public int AssetPriority
        {
            get
            {
                return m_ResourceLoadHelper.AssetPriority;
            }
            set
            {
                m_ResourceLoadHelper.AssetPriority = m_AssetPriority = value;
            }
        }
        #endregion
        ...
        private void Start()
        {
            ...
            m_ResourceLoadHelper = Helper.CreateHelper(m_ResourceLoadHelperTypeName, m_ResourceLoadHelper);
            ...
            m_ResourceLoadHelper.SetReadOnlyPath(Application.streamingAssetsPath);
            if (m_ReadWritePathType == ReadWritePathType.TemporaryCache)
            {
                m_ResourceLoadHelper.SetReadWritePath(Application.temporaryCachePath);
            }
            else
            {
                ...
                m_ResourceLoadHelper.SetReadWritePath(Application.persistentDataPath);
            }

            m_ResourceLoadHelper.DefaultPackageName = PackageName;
            m_ResourceLoadHelper.PlayMode = PlayMode;
            m_ResourceLoadHelper.VerifyLevel = VerifyLevel;
            m_ResourceLoadHelper.Milliseconds = Milliseconds;
            m_ResourceLoadHelper.InstanceRoot = transform;
            // TODO 服务器地址
            m_ResourceLoadHelper.HostServerURL = "";
            m_ResourceLoadHelper.Initialize();
            m_ResourceLoadHelper.AssetAutoReleaseInterval = m_AssetAutoReleaseInterval;
            m_ResourceLoadHelper.AssetCapacity = m_AssetCapacity;
            m_ResourceLoadHelper.AssetExpireTime = m_AssetExpireTime;
            m_ResourceLoadHelper.AssetPriority = m_AssetPriority;
        ...
        public async UniTask<InitializationOperation> InitPackage(string packageName = "")
        {
            ...
            return await m_ResourceLoadHelper.InitPackage(string.IsNullOrEmpty(packageName) ? PackageName:packageName);
        }
        ...
        {
            return m_ResourceLoadHelper.HasAsset(location, packageName: customPackageName);
        }
        ...
        {
            return m_ResourceLoadHelper.CheckLocationValid(location, packageName: customPackageName);
        }
        ...
        {
            return m_ResourceLoadHelper.GetAssetInfos(resTag, packageName: customPackageName);
        }
        ...
        {
            return m_ResourceLoadHelper.GetAssetInfos(tags, packageName: customPackageName);
        }
        ...
        {
            return m_ResourceLoadHelper.GetAssetInfo(location, packageName: customPackageName);
        }
        #endregion
        ...
        //     }
        //
        //     return m_ResourceLoadHelper.LoadAsset<T>(location, packageName);
        // }
        ...
        //     }
        //
        //     return m_ResourceLoadHelper.LoadGameObject(location, parent, packageName);
        // }
            ...
            string packageName = "") where T : UnityEngine.Object
        {
            ...
            return await m_ResourceLoadHelper.LoadAssetAsync<T>(location, cancellationToken, packageName);
        }
            ...
            string packageName = "")
        {
            ...
            return await m_ResourceLoadHelper.LoadGameObjectAsync(location, parent, cancellationToken, packageName);
        }
        ...
        private void Update()
        {
                                             ...
                                             m_PreorderUnloadUnusedAssets && m_LastUnloadUnusedAssetsOperationElapseSeconds >= m_MinUnloadUnusedAssetsInterval))
            {
                ...
                {
                    m_ResourceLoadHelper.UnloadUnusedAssets();
                }
            }
